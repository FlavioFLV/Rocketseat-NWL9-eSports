                    ...
                    <div className='flex gap-6'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <ToggleGroup.Root type='multiple' className='grid grid-cols-4 gap-2' value={weekDays} onValueChange={setWeekDays}>
                                ...
                                <ToggleGroup.Item value="1" title='Segunda-Feira' className='w-8 h-8 rounded bg-zinc-900'>S</ToggleGroup.Item>
                                <ToggleGroup.Item value="2" title='Terça-Feira' className='w-8 h-8 rounded bg-zinc-900'>T</ToggleGroup.Item>
                                <ToggleGroup.Item value="3" title='Quarta-Feira' className='w-8 h-8 rounded bg-zinc-900'>Q</ToggleGroup.Item>
                                <ToggleGroup.Item value="4" title='Quinta-Feira' className='w-8 h-8 rounded bg-zinc-900'>Q</ToggleGroup.Item>
                                <ToggleGroup.Item value="5" title='Sexta-Feira' className='w-8 h-8 rounded bg-zinc-900'>S</ToggleGroup.Item>
