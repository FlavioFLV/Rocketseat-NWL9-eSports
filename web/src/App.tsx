...
function App() {
  ...
  return (
    <div className='max-w-[1344px] mx-auto flex flex-col items-center margin my-20'>
      <img src={logoImg} alt="" />
              ...
              <div className='flex gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <div className='grid grid-cols-4 gap-2'>
                    ...
                    <button title='Segunda-Feira' className='w-8 h-8 rounded bg-zinc-900'>S</button>
                    <button title='Terça-Feira' className='w-8 h-8 rounded bg-zinc-900'>T</button>
                    <button title='Quarta-Feira' className='w-8 h-8 rounded bg-zinc-900'>Q</button>
                    <button title='Quinta-Feira' className='w-8 h-8 rounded bg-zinc-900'>Q</button>
                    <button title='Sexta-Feira' className='w-8 h-8 rounded bg-zinc-900'>S</button>
